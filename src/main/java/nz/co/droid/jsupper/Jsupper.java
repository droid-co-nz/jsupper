...
public class Jsupper {
	...
	/**
	 * Returns specified type using registered converter (gets first found value).
	 * If none of the converters can't handle given type, returns null.
	 * 
	 * @param type requested type
	 * @param elements jsoup elements
	 ...
	 * 
	 * @param query form element selector
	 * @param params request parameters
	 * @throws JsupperException when something goes wrong
	 */
	 ...
	 * @param query form element selector
	 * @param params request parameters
	 * @param button form button used to 'click'
	 * @throws JsupperException when something goes wrong
	 */
